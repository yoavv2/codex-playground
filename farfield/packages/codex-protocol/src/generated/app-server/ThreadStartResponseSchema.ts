...
export const ThreadStartResponseSchema = z.object({ "approvalPolicy": z.enum(["untrusted","on-failure","on-request","never"]), "cwd": z.string(), "model": z.string(), "modelProvider": z.string(), "reasoningEffort": z.union([z.enum(["none","minimal","low","medium","high","xhigh"]).describe("See https://platform.openai.com/docs/guides/reasoning?api-mode=responses#get-started-with-reasoning"), z.null()]).optional(), "sandbox": z.any().superRefine((x, ctx) => {
